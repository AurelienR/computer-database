...
insert into user_role (id,name) values ( 2,'ROLE_USER');

insert into user_entity (id,username,password,user_role_id) values ( 1,'admin','admin',1);
insert into user_entity(id,username,password,user_role_id) values ( 2,'user','user',2);